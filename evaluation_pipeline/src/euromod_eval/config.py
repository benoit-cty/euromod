...
# evaluation_pipeline/ (this file lives in src/euromod_eval/).
...
def load_eval_config() -> EvalConfig:
    """Build the config from .env (repo root, then evaluation_pipeline/) and the process env."""
    ...
    return EvalConfig(
        ...
        phoenix_project=_env("EVAL_PHOENIX_PROJECT", "euromod-evaluation"),
    )
