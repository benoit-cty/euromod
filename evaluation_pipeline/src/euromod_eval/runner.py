...
Reuses euromod_workflow end-to-end (same retrieval, prompts, critique, Phoenix
...
from euromod_workflow import AGENT_VERSION
from euromod_workflow.config import load_config as load_workflow_config
from euromod_workflow.pipeline import run_parameter
from euromod_workflow.prompts import PROMPT_VERSION
from euromod_workflow.tracing import setup_tracing
