Qui doit payer la contribution exceptionnelle sur les hauts revenus ? | Service Public
...
Ces seuils d'imposition n'augmentent pas si vous avez une ou plusieurs personnes
...
Tableau - Contribution exceptionnelle sur les hauts revenus : taux applicable selon le revenu fiscal de référence et la situation de famille
...
Pour un célibataire disposant d'un revenu fiscal de référence de

400 000 €

, la contribution exceptionnelle est de :
...
Le montant de la contribution exceptionnelle sur les hauts revenus est indiqué sur
...
Un système de lissage (aussi appelé

mécanisme du quotient

) peut s'appliquer pour atténuer votre imposition.

Vous devez bénéficier de revenus considérés comme
...
C'est une contribution supplémentaire qui s'applique à certains contribuables

domiciliés fiscalement

en France.

Cette contribution doit s’appliquer jusqu’à l'imposition des revenus de l’année pour laquelle sera constaté un déficit du budget national inférieur à 3 % du
...
La contribution différentielle vise à assurer une imposition minimale de
...
Vous êtes concerné par la contribution différentielle sur les hauts revenus si votre
...
Vous êtes soumis à la contribution différentielle si votre taux moyen d'imposition est inférieur à

20 %

.

La contribution différentielle est calculée à partir de éléments suivants :
...
Montant résultant du total de l’impôt sur le revenu, de la contribution exceptionnelle sur les hauts revenus et des

prélèvements libératoires

: titleContent

sur l’impôt sur le revenu, majoré de
...
L'aide d'un professionnel, par exemple un expert-comptable, peut s'avérer nécessaire pour le calcul de l'acompte.

Pour

vérifier si vous êtes concerné

par la contribution différentielle sur les hauts revenus (CDHR), vous pouvez utiliser un simulateur :

Vérifier si l’on est concerné par la contribution différentielle sur les hauts revenus (revenus 2025)

Le simulateur vous permet de calculer le

montant de la contribution

à partir de l’estimation de vos revenus de 2025.

La contribution différentielle due pour l’année 2025 a donné lieu au
...
du montant de la contribution estimé par le contribuable.

L’acompte versé figurera
...
, à la suite de la déclaration des revenus de 2025 (au printemps 2026).
...
En cas de paiement tardif ou insuffisant, une pénalité de
...
déclaration entre le 1

er

décembre et le 15 décembre 2026

dans votre espace en ligne :

Impôts : accéder à votre espace Finances publiques

La contribution différentielle due pour l’année 2026 donne lieu au
...
Il doit être versé entre le 1

er

et le 15 décembre 2026.
...
, à la suite de la déclaration des revenus de 2026 (au printemps 2027).
...
Enfant mineur ou majeur rattaché au foyer fiscal de ses parents, qui est pris en compte pour le calcul de l'impôt sur le revenu

Indicateur économique de référence qui permet de mesurer la production de richesse d’un pays, selon la valeur de tous les biens et services produits sur une année

Prélèvement à la source d'un impôt forfaitaire sur certains revenus (de placements par exemple), qui dispense le contribuable de l'obligation d'intégrer ces revenus dans le calcul de son impôt. Il n'est pas obligatoire, le contribuable peut opter pour une imposition au barème progressif de l'impôt.
