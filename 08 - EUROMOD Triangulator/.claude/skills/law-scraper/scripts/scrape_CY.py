...
BASE_DIR = Path("legislation/CY")
RAW_DIR = BASE_DIR / "raw"
PENDING_FILE = BASE_DIR / "PENDING.md"

URLS = {
    "Law_210_2022_PDF": "https://www.cylaw.org/nomoi/arith/2022_1_210.pdf",
    "Law_59_2010_HTML": "https://www.cylaw.org/nomoi/enop/non-ind/2010_1_59/full.html",
    "Law_168_2012_HTML": "https://www.cylaw.org/nomoi/enop/non-ind/2012_1_168/full.html",
    "MOEC_Student_Grant": "http://www.moec.gov.cy/ypiresia_foititikis_merimnas/foititiki_chorigia.html"
}
...
def extract_pdf(pdf_path, md_path):
    doc = fitz.open(pdf_path)
    text = ""
    for page in doc:
        text += page.get_text() + "\n\n"
    md_path.write_text(text, encoding="utf-8", errors="ignore")
