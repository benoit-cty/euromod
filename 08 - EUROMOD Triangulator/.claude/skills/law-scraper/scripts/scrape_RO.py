...
BASE_DIR = Path("legislation/RO")
RAW_DIR = BASE_DIR / "raw"
PENDING_FILE = BASE_DIR / "PENDING.md"

URLS = {
    "INSSE_Wage": "https://statistici.insse.ro/shop/",
    "CNPP_Pension": "http://www.cnpp.ro",
    "MMUNCII_Stats": "http://www.mmuncii.ro/j33/index.php/ro/transparenta/statistici/date-statistice"
}
