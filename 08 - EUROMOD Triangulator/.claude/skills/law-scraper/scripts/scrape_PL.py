...
BASE_DIR = Path("legislation/PL")
RAW_DIR = BASE_DIR / "raw"
PENDING_FILE = BASE_DIR / "PENDING.md"

URLS = {
    "ZUS_Skaldki": "https://www.zus.pl/baza-wiedzy/skladki-wskazniki-odsetki/skladki/wysokosc-skladek-na-ubezpieczenia-spoleczne",
    "ZUS_ENG_PDF": "http://www.zus.pl/files/Zabezpieczenie_ENG.pdf",
    "KRUS_Info_PDF": "https://www.krus.gov.pl/fileadmin/moje_dokumenty/obrazki/Dokumenty/Wydarzenia_2020/broszura/Informacje_Podstawowe_2019_EN_d.pdf",
    "ZUS_POX": "https://zus.pox.pl/skladki-zus-2021.htm"
}
