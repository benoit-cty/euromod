...
from euromod_ingest.cli import PROGRESS_PREFIX, app
...
def test_translation_json_progress_emits_prefixed_json(capsys) -> None:
    ...
    from euromod_ingest.cli import _translation_json_progress
...
def test_embedding_json_progress_skips_per_chunk_candidate_events(capsys) -> None:
    ...
    from euromod_ingest.cli import _embedding_json_progress
