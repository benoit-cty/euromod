...
docker exec -i nomotheca-legislation-db psql -U jrc -d legislation < Nomotheca-RAG/db/demo_queries.sql
docker compose down -v      # full reset
```

(Windows note: run from WSL2 where Docker is installed; the repo path is reachable under `/mnt/c/Users/Ben/Documents/Euromod/Benoit/Nomotheca-RAG/db`.)
