...
Purpose: map the 702 machine-extracted FR parameters to the sections of `Nomotheca-RAG/country_reports/Y16_CR_FR.pdf` (companion extraction: [Y16_CR_FR.md](Y16_CR_FR.md)), to decide **what the RAG must ingest** and **how to build the evaluation pipeline** (see `00_project-overview.md`, Activities 2 & 4).
